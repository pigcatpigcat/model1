...
class SalientSleepNet(BasicModel):
    def __init__(self):
        ...
        self.feature = nn.Sequential(
            nn.Conv2d(self.filters[0],self.filters[0],kernel_size=(1,1),stride = (1,1),bias=False),
            nn.Tanh(),

            nn.AdaptiveAvgPool2d((self.sequence_length,1)),
            nn.Conv2d(16,1,kernel_size=(self.kernel_size,1),stride = (1,1),padding = self.padding,bias=False),
