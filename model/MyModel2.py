...
class Temporal_feature_EEG(nn.Module):
    def __init__(self, channels):
        ...
        self.features1 = nn.Sequential(
            nn.Conv2d(channels, 64, kernel_size=9, stride=1, bias=False, padding=4),
            nn.BatchNorm2d(64),
            nn.LeakyReLU(),
            ...
            nn.Conv2d(64, 128, kernel_size=9, stride=1, bias=False, padding=4),
            nn.BatchNorm2d(128),
            nn.LeakyReLU(),

            nn.Conv2d(128, 128, kernel_size=9, stride=1, bias=False, padding=4),
            nn.BatchNorm2d(128),
            nn.LeakyReLU(),
        ...
        self.features2 = nn.Sequential(
            nn.Conv2d(channels, 64, kernel_size=5, stride=1, bias=False, padding=2),
            nn.BatchNorm2d(64),
            nn.LeakyReLU(),
            ...
            nn.Conv2d(128, 128, kernel_size=5, stride=1, bias=False, padding=2),
            nn.BatchNorm2d(128),
            nn.LeakyReLU(),
...
class MySleepNet2(BasicModel):
    def __init__(self, cfg):  # ,d_model,afr_reduced_cnn_size):
        super(MySleepNet2, self).__init__()
