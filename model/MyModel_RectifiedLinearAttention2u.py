...
from model.attention import RectifiedLinearAttention
from re import T
...
class MyModel(nn.Module):
    def __init__(self):
        ...
        self.linear0=nn.Sequential(nn.Linear(3000, 192), nn.ReLU(True))
        self.attention=RectifiedLinearAttention(192, 3, 64, 0., True)
        # self.autoformer=Autoformer()
        self.linear1 = nn.Sequential(nn.Linear(192, 10), nn.ReLU(True))
        self.linear2 = nn.Sequential(nn.Linear(300, 5), nn.Softmax(dim=1))
